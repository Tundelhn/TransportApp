  ...
  return (
    <View style={Styles.Containerr}>
            ...
            <View style={Styles.Wit}>
              <AppButton buttonStyle={{  top:0, height:50, width:130, backgroundColor: colors.blue,  }}    onPress={() =>console.log('Go ahead')} title='Start Trip' />
              <AppButton
                buttonStyle={{ top:0, height:50, width: 130, backgroundColor: colors.white, borderWidth: 1, borderColor: colors.blue }}
